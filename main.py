...
if len(sys.argv) != 2:
    print(
        "Give the path to the examples/faces directory & the type as the argument to this "
        "program. For example, if you are in the python_examples folder then "
        "execute this program by running:\n"
        "    ./train_object_detector.py ../examples/faces mp4")
    exit()
...
detector2 = dlib.fhog_object_detector("detector_small.svm")
